        ...
        child: Column(
          children: [
            ...
            SingleChildScrollView(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 24), // Added explicit spacing
                  _buildTeamMember('images/james.png', 'Dr. James Mwangi\n  Board Member'),
                  const SizedBox(width: 24), // Added explicit spacing
                  _buildTeamMember('images/mercy.png', 'Mercy Wanjiru\nResearch director'),
                  // const SizedBox(width: 24), // Added explicit spacing
            ...
            const SingleChildScrollView(
              scrollDirection: Axis.horizontal,
              padding: EdgeInsets.symmetric(horizontal: 20.0, vertical: 8.0), // Added padding
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [ // Changed to non-const to allow for variable image
                          ...
                          const Align(
                            alignment: Alignment.center,
                            child: Text( // Removed redundant Center
...
const SizedBox(height: 20), // Added space between title and partners section
